defmodule X32Remote.Supervisor do
  ...
  @default_watcher_name X32Remote.Mixer.Watcher
  ...
  def start_link(opts) do
    ...
    {watcher_name, opts} = Keyword.pop(opts, :watcher_name, @default_watcher_name)
    ...
    children = [
      ...
      {X32Remote.Watcher, client: client_name, name: watcher_name}
    ]
